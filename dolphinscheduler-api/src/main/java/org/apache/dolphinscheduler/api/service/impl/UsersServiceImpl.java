...
public class UsersServiceImpl extends BaseServiceImpl implements UsersService {
    ...
    public Map<String, Object> createUser(User loginUser,
                                          ...
                                          String alertGroupList) throws Exception {
    ...
    public User createUserIfNotExists(String userName, String userPassword, String email, String phone,
                                      String tenantCode,
                                      String queue,
                                      int state,String workerGroupList,String alertGroupList) throws IOException {
        User user = userMapper.queryByUserNameAccurately(userName);
        if (Objects.isNull(user)) {
            Tenant tenant = tenantMapper.queryByTenantCode(tenantCode);
            user = createUser(userName, userPassword, email, tenant.getId(), phone, queue, state,workerGroupList,alertGroupList);
            return user;
        }

        updateUser(user, user.getId(), userName, userPassword, email, user.getTenantId(), phone, queue, state, null,workerGroupList,alertGroupList);
